...
}: { card: { title: string, id: string, text: string, race: string, rarity: string, set: string, cost: number, strength: number, health: number } }) =>
  <svg className={'card ' + className} viewBox="0 0 751 1041">
    <title>Card</title>
    <defs>
    ...
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" type="MSPage">
      <g id="Card" type="MSLayerGroup" transform="translate(-14.000000, -59.000000)">
        <image id="GVG_096" type="MSBitmapLayer" x="117" y="78" width="563" height="563" href={`/static/${id}.jpg`} clipPath="url(#image-clip-path)" />
        ...
        <g id="Gem" transform="translate(18.000000, 81.000000)">
          ...
          <text id="value" stroke="#000000" strokeWidth="13px" fill="#D8D8D8" type="MSTextLayer" fontFamily="Belwe" paintOrder="stroke" fontSize="164" fontWeight="400" alignment="middle">
        ...
        <g id="Race" transform="translate(132.000000, 940.000000)">
          ...
          <text id="Mech" stroke="#000000" strokeWidth="7px" fill="#D8D8D8" fontFamily="Belwe" paintOrder="stroke" fontSize="48" fontWeight="400" alignment="middle">
        ...
        <g id="Health" transform="translate(598.000000, 882.000000)">
          ...
          <text id="value" stroke="#000000" strokeWidth="13px" fill="#D8D8D8" type="MSTextLayer" fontFamily="Belwe" paintOrder="stroke" fontSize="160" fontWeight="400" alignment="middle">
